...
class QtWin(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def disableBlurBehindWindow(window:PySide2.QtWidgets.QWidget): ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def enableBlurBehindWindow(window:PySide2.QtWidgets.QWidget): ...
    @typing.overload
    @staticmethod
    def enableBlurBehindWindow(window:PySide2.QtWidgets.QWidget, region:PySide2.QtGui.QRegion): ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def extendFrameIntoClientArea(window:PySide2.QtWidgets.QWidget, left:int, top:int, right:int, bottom:int): ...
    @typing.overload
    @staticmethod
    def extendFrameIntoClientArea(window:PySide2.QtWidgets.QWidget, margins:PySide2.QtCore.QMargins): ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def markFullscreenWindow(window:PySide2.QtWidgets.QWidget, fullscreen:bool=...): ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def resetExtendedFrame(window:PySide2.QtWidgets.QWidget): ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def setWindowDisallowPeek(window:PySide2.QtWidgets.QWidget, disallow:bool): ...
    @typing.overload
    @staticmethod
    def setWindowExcludedFromPeek(window:PySide2.QtGui.QWindow, exclude:bool): ...
    @typing.overload
    @staticmethod
    def setWindowExcludedFromPeek(window:PySide2.QtWidgets.QWidget, exclude:bool): ...
    @typing.overload
    @staticmethod
    def setWindowFlip3DPolicy(window:PySide2.QtGui.QWindow, policy:PySide2.QtWinExtras.QtWin.WindowFlip3DPolicy): ...
    @typing.overload
    @staticmethod
    def setWindowFlip3DPolicy(window:PySide2.QtWidgets.QWidget, policy:PySide2.QtWinExtras.QtWin.WindowFlip3DPolicy): ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def taskbarActivateTab(window:PySide2.QtWidgets.QWidget): ...
    @typing.overload
    @staticmethod
    def taskbarActivateTabAlt(arg__1:PySide2.QtGui.QWindow): ...
    @typing.overload
    @staticmethod
    def taskbarActivateTabAlt(window:PySide2.QtWidgets.QWidget): ...
    @typing.overload
    @staticmethod
    def taskbarAddTab(arg__1:PySide2.QtGui.QWindow): ...
    @typing.overload
    @staticmethod
    def taskbarAddTab(window:PySide2.QtWidgets.QWidget): ...
    @typing.overload
    @staticmethod
    def taskbarDeleteTab(arg__1:PySide2.QtGui.QWindow): ...
    @typing.overload
    @staticmethod
    def taskbarDeleteTab(window:PySide2.QtWidgets.QWidget): ...
    @typing.overload
    @staticmethod
